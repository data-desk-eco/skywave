...
import { initMiniMap, addReceiverToMiniMap, setVesselOnMiniMap, setTdoaOnMiniMap } from "./map.js?v=21";
import { REGIONS, REGION_STORAGE_KEY, currentRegion, midIso } from "./regions.js?v=21";
