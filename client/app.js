...
import { initMiniMap, addReceiverToMiniMap, setVesselOnMiniMap, setTdoaOnMiniMap } from "./map.js?v=18";
import { REGIONS, REGION_STORAGE_KEY, currentRegion, midIso } from "./regions.js?v=18";
